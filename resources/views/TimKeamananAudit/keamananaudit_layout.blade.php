                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('dashboard-audit') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        {{-- <li class="sidebar-item">
                            <a href="{{ route('audit-code.index') }}" class='sidebar-link'>
                                <i class="bi bi-key-fill"></i>
                                <span>Kode Audit</span>
                            </a>
                        </li> --}}
                        ...
                        <li class="sidebar-item has-sub ">
                            <a href="#" class='sidebar-link'>
                                ...
                                <span>Penerimaan Pengajuan Audit</span>
                            </a>

                            <ul class="submenu">
                                <li class="submenu-item  ">
                                    <a href="{{ route('penerimaan-rutin.index') }}" class="submenu-link">Rutin</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ route('penerimaan-insidental.insidentalpenerimaan') }}"
                        ...
                        <li class="sidebar-item has-sub ">
                            ...
                            <ul class="submenu">
                                <li class="submenu-item  ">
                                    <a href="{{ route('hasil-rutin.hasilrutin') }}" class="submenu-link">Rutin</a>
                                </li>
                                <li class="submenu-item  ">
