...
@section('content')
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/auth/auditinsidental-admin">Pengajuan Audit Sistem
                                    Informasi
                                    Insidental</a></li>
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('pelaporan-insidental.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
