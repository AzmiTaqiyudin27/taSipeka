            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.auditInsidental.length > 0) {
                        ...
                        var action = "{{ route('penindakan-insidental.update', '') }}/" +
                            id;
                        form.attr("action", action)
                ...
                <option class="form-option" value="">-Unit Kerja-</option>
                    ...
                    <input type="text" value="${response.auditInsidental[0].judul}" name="judul" id="judul" class="form-control" placeholder="Judul" required>
                </div>
                             <div class="form-group">
                ...
                <option class="form-option" value="">-Unit Kerja-</option>
                    ...
                    console.log(item.id);
                     ...
                     return `<option class="form-option" value="${item.id}" ${isSelected}>${item.username}</option>`;
                                 ...
                                 <div class="form-group">
                    <label for="judul" class="form-label">Judul</label>
                    <input type="text"  name="judul" id="judul" class="form-control" value="${response.auditProses.judul}" placeholder="Judul" required>
                </div>
                             <div class="form-group">
                                    <label for="versi" class="form-label">Versi</label>
                                    <select name="versi" class="form-select">
