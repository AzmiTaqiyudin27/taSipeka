...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2024 at 08:02 PM
...
(25, 'A001', 2, 6, '<p>tes</p>', 'tes', '<p>tes</p>', '<p>tes</p>', '2024-08-26', '1', '<p>tes</p>', '<p>tes</p>', '<p>tes</p><figure class=\"image\"><img src=\"/storage/uploads/1724631647_tes foto.png\"></figure>', '<p>tes</p>', 'proses', '2024-08-25 17:20:30', '2024-08-25 17:20:51');
...
(34, 'A001', 2, 6, '2024-08-26', '1', '<p>tes</p><figure class=\"image\"><img src=\"/storage/uploads/1724631192_tes foto.png\"></figure>', 'tes', '<p>tes</p>', '<p><strong>tes</strong></p>', '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', 'proses', '2024-08-25 17:13:24', '2024-08-25 17:13:24'),
(35, 'A002', 2, 12, '2024-08-26', '1', '<p>tes</p>', 'tes', '<p>tes</p><figure class=\"image\"><img src=\"/storage/uploads/1724631232_tes foto.png\"></figure>', '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', 'proses', '2024-08-25 17:14:00', '2024-08-25 17:14:00'),
(36, 'A002', 2, 12, '2024-08-26', '2', '<p>tes</p>', 'tes', '<p>tes</p><figure class=\"image\"><img src=\"/storage/uploads/1724631232_tes foto.png\"></figure>', NULL, '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', '<p>tes</p>', 'draft', '2024-08-25 17:16:56', '2024-08-25 17:16:56'),
(37, 'A001', 2, 6, '2024-08-26', '1', '<p>tes</p><figure class=\"image\"><img src=\"/storage/uploads/1724631192_tes foto.png\"></figure>', 'tes', '<p>tes</p>', '<p><strong>tes</strong></p>', '<p>tes</p>', '<p>tes</p>', NULL, NULL, 'draft', '2024-08-25 17:18:03', '2024-08-25 17:18:03');
...
(13, '2024_06_15_011227_tb_kode_audit', 1),
...
--
-- Table structure for table `pelaporan_insidentals`
--
...
--
-- Dumping data for table `pelaporan_insidentals`
--

INSERT INTO `pelaporan_insidentals` (`id`, `user_id`, `tanggal_lapor`, `nama_sistem`, `kendala`, `keterangan`, `foto`, `status_approved`, `is_ditolak`, `created_at`, `updated_at`) VALUES
(14, 6, '2024-08-25 00:00:00', 'tes buat sistem fakultas kedokteran 1', 'tes', 'tes', '[\"tes foto.png\"]', '2', NULL, '2024-08-25 07:56:55', '2024-08-25 07:57:18'),
(16, 6, '2024-08-26 00:00:00', 'tes buat sistem fakultas kedokteran 2', 'tes', 'tes', '[\"tes foto.png\"]', '1', NULL, '2024-08-25 19:23:46', '2024-08-25 19:23:46');

-- --------------------------------------------------------

--
-- Table structure for table `pelaporan_rutins`
--
...
--
-- Dumping data for table `pelaporan_rutins`
--

INSERT INTO `pelaporan_rutins` (`id`, `user_id`, `tanggal_lapor`, `nama_sistem`, `versi`, `deskripsi`, `dokumen`, `status_approved`, `is_ditolak`, `created_at`, `updated_at`) VALUES
(47, 6, '2024-08-25 00:00:00', 'tes bulan agustus sistem fakultas kedokteran 2', '1', 'tes', '[\"tes foto.png\"]', '2', NULL, '2024-08-25 07:55:44', '2024-08-25 07:57:14'),
(49, 6, '2024-08-26 00:00:00', 'tes bulan agustus sistem fakultas kedokteran 3', '1', 'tes', '[\"tes foto.png\"]', '3', 'tes', '2024-08-25 19:24:10', '2024-08-25 21:22:24');
...
('UlQ9HT1nl5f1ObEqjw8RKy0aF7MtaDlZTXBXuKnR', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36 Edg/128.0.0.0', '', 1724777901, NULL, NULL);
...
--
-- Indexes for table `pelaporan_insidentals`
--
ALTER TABLE `pelaporan_insidentals`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pelaporan_rutins`
--
ALTER TABLE `pelaporan_rutins`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pelaporan_insidentals`
--
ALTER TABLE `pelaporan_insidentals`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `pelaporan_rutins`
--
ALTER TABLE `pelaporan_rutins`
